...
E2E_CONF = {
    ...
    "labobocsi": {
        ...
        "IRDETO": {"host": "lgiobo.stage.ott.irdeto.com", "port": 80},
        # Used as jump server to reach Airflow workers
        # RobotFramework_Proxy_Tenant_SIS in LAB_SS_NETWORK LLD
        "AIRFLOW_WORKERS_JUMP_SERVER": {"host": "172.23.87.216", "port": 22,
                                        "user": "oboadm", "password": "oboadm1n"},
        # RobotFramework_Proxy_Tenant_SIE in LAB_5A_INFRA LLD (managment IP)
        "TRANSCODER_WORKERS_JUMP_SERVER": {"host": "172.23.87.185", "port": 22,
                                           "user": "oboadm", "password": "oboadm1n"},
        ...
        "ORIGINS": [
            # {
            #     "host": "172.23.87.16", "port": 22, "user": "root", "password": "F@brix",
