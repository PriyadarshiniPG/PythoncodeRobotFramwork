...
Force Tags        JIRA_CatchupPolsatSportPremium1HD    PROD-PL-APOLLO
...
Open CatchUP From MainMenu
    ...
    set context     CatchupPolsatSportPremium1HD
    ...
    I Press     OK
    Move Focus to Option in Value Picker    textValue:Polsat Sport Premium 1 HD    DOWN
    I Press     OK
    log action     CatchupPolsatSportPremium1HD
    Wait Until Keyword Succeeds    ${DEFAULT_RETRY_TIMEOUT}    ${DEFAULT_RETRY_INTERVAL}
    ...    Catchup Catalog for Polsat Sport Premium 1 HD is shown
    log action     CatchupPolsatSportPremium1HD_Done
...
Stop Playback and Validate the Episode Details Page
    ...
    set context     CatchupPolsatSportPremium1HD_Back
    I Press    BACK
    log action    OpeningInfoPage
    wait until keyword succeeds    ${DEFAULT_RETRY_TIMEOUT}    ${DEFAULT_RETRY_INTERVAL}    Details Page is Shown
    log action  OpeningInfoPage_Done
