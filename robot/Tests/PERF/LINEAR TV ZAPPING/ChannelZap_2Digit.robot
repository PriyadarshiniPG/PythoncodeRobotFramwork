...
Force Tags        JIRA_ChannelZap_2Digit   P4    DONE    SANITY    PROD-NL-SELENE    PROD-PL-APOLLO   PROD-NL-EOS    PROD-NL-EOSV2    PROD-NL-APOLLO    PREPROD-CH-EOS   PROD-CH-EOS    PROD-CH-APOLLO    PREPROD-CH-EOSV2    PROD-CH-EOSV2    PREPROD-BE-APOLLO-V1-PLUS
...
Tune To PreDefined Channel
    ...
    [Tags]    TOOL_CPE
    Run Keyword And Assert Failed Reason    tune to channel ${CHANNEL_ZAP_TWO_DIGIT_INIT_CHANNEL}     'Failed to tune to predefined channel.'

#------------------------------ STEP 2 ------------------------------#
Tune to 2 Digit Channel
    ...
    [Tags]    TOOL_CPE
    set context    ChannelZap_2Digit
    ${converted_channel}    Convert To String    ${CHANNEL_ZAP_TWO_DIGIT_FINAL_CHANNEL}
