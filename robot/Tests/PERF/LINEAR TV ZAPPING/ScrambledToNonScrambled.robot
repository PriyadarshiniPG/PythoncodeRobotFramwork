...
Force Tags        JIRA_ScrambledToNonScrambled    PROD-NL-EOS    PROD-NL-EOSV2    PROD-NL-APOLLO   PROD-CH-EOS    PREPROD-CH-EOS   PROD-NL-SELENE    PROD-UK-EOS  PREPROD-UK-EOS  PROD-IE-EOS    PREPROD-IE-EOS    PROD-PL-APOLLO    PROD-CH-APOLLO    PREPROD-CH-EOSV2    PROD-CH-EOSV2    PROD-UK-BENTO    PREPROD-UK-BENTO    PREPROD-BE-APOLLO-V1-PLUS
...
Tune to Non Scrambled Channel
    ...
    set context    ScrambledToNonScrambled
    ${converted_channel}    Convert To String    ${CHANNEL_ZAP_NonScrambled_HD_CHANNEL}
