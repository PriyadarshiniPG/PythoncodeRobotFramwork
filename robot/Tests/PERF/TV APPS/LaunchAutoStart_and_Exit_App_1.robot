...
Force Tags        LaunchAutoStart_and_Exit_App_1    INTERIM   PROD-NL-EOS    PROD-NL-EOSV2    PROD-NL-APOLLO    PROD-CH-EOS    PREPROD-CH-EOS    PROD-CH-APOLLO    PREPROD-CH-EOSV2    PROD-CH-EOSV2    PROD-NL-SELENE    PROD-UK-EOS    PROD-IE-EOS    R4_29    TV_APPS    UK_33    PREPROD-BE-APOLLO-V1-PLUS
...
Tune to App Channel
    ...
    [Tags]    TOOL_CPE
    set context    AutoStart_Launch_App_1
    ${converted_channel}    Convert To String    ${CHANNEL_APP_1}
    ${APP_Channel}    I Fetch App Name for given Logical Channel Number    ${converted_channel}
    set suite variable   ${app_channel_1}    ${APP_Channel}
...
Validate app channel is launched
    ...
    Run Keyword And Assert Failed Reason    I check '${app_channel_1}' App is loaded    'APP not launched properly'
...
Exit App channel
    ...
    set context    AutoStart_Exit_App_1
