...
Force Tags        JIRA_CCNAPP_1  PREPROD-UK-EOS  PROD-IE-EOS    PREPROD-IE-EOS    PROD-PL-APOLLO    TV_APPS    PROD-BE-EOSV2    PREPROD-BE-APOLLO-V1-PLUS
...
Navigate to App
    ...
    I Select TV App    ${APP_1}

Validate app is launched
    [Documentation]    Validate if app is launched
    [Setup]    Skip If Last Fail
    set context    Launch_APP_1
    log action    ApplicationLaunched
    Run Keyword And Assert Failed Reason    I check '${APP_1}' App is loaded    'APP not launched properly'
