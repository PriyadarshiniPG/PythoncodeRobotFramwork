...
Force Tags        JIRA_Categories    P4    DONE    PROD-UK-EOS   PREPROD-UK-EOS     TV_APPS    PROD-UK-BENTO    PREPROD-UK-BENTO
...
Navigate to predefined VOD asset
    ...
    Move Focus to Section    ${VOD_CATEGORIES_LABEL}    textValue
    VOD Grid Screen for given section is shown    ${VOD_CATEGORIES_LABEL}
    ...
    I press    DOWN
    I Wait for 2 seconds
    Moved to Named VOD Collection     ${VOD_CATEGORY_COLLECTION}
    Moved to Named Tile in Collection    ${VOD_CATEGORY_ASSET}
