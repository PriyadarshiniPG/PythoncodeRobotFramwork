...
Force Tags        JIRA_ContinueWatchingReplay    INTERIM    PROD-NL-SELENE    PROD-NL-EOS    PROD-NL-EOSV2    PROD-NL-APOLLO    PROD-CH-EOS    PREPROD-CH-EOS    PROD-UK-EOS  PREPROD-UK-EOS   PROD-IE-EOS    PREPROD-IE-EOS    PROD-PL-APOLLO    VIDEO_PLAYOUT    PROD-CH-APOLLO    PREPROD-CH-EOSV2    PROD-CH-EOSV2     TV_APPS    PROD-BE-EOSV2    PREPROD-BE-APOLLO-V1-PLUS
...
Invoke Main Menu
    ...
    set context    ContinueWatchingPlayoutFromStart(Replay)
...
Navigate to predefined VOD asset
    ...
    Moved to Named Tile in Collection    ${SAVED_CONTINUE_WATCHING_REPLAY_ASSET}
...
Validate Playback with Play From Start
    [Documentation]    Start Playback of Replay Asset from beginning
    #[Setup]    Skip If Last Fail
...
Exit PlayBack and Return to Details Page
    [Documentation]    Navigate to the details page of VOD asset and verify the contents
    #[Setup]    Skip If Last Fail
    set context    ContinueWatchingPlayoutFromStart_Back(Replay)
...
Invoke and Validate the Details Page for Continue Watching
    [Documentation]    Navigate to the details page of VOD asset and verify the contents
    #[Setup]    Skip If Last Fail
    set context    ContinueWatching(Replay)
    I Press    INFO
    I wait for 2 seconds
    I Press    OK
    log action    OpeningInfoPage
...
Validate Playback with Continue Watching
    [Documentation]    Resume Playback of Replay Asset
    #[Setup]    Skip If Last Fail
