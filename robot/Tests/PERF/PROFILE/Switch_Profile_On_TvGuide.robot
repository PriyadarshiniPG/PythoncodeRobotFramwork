...
Force Tags        JIRA_Guide_ProfileSwitch   PROD-NL-EOS    PROD-NL-EOSV2    PROD-NL-APOLLO    PROD-CH-APOLLO    PROD-CH-EOSV2    PROD-CH-EOS
...
Validate Guide is displayed properly after profile switch
     [Documentation]    Validate Guide is displayed properly after profile switch
     [Tags]    CCH-3407
     [Setup]    Skip If Last Fail
     I open guide through main menu
     wait until keyword succeeds    50s    0s    I expect page contains 'id:Guide.View'
     I wait for 2 second
     I press    PROFILE
     I wait for 2 second
     I press    RIGHT
     ...
     wait until keyword succeeds    50 s    0 s    Validate Profile switch from Tv Guide
