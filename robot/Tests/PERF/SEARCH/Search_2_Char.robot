...
Open Search thorugh CMM
   ...
   Run Keyword And Assert Failed Reason     I have searched for '${SEARCH_CHAR_2}'     'Failed to Search for content.'
   log action  SearchResultsDisplayed
   wait until keyword succeeds    ${DEFAULT_RETRY_TIMEOUT}   ${DEFAULT_RETRY_INTERVAL}    Search results are shown for '${SEARCH_CHAR_2}'
